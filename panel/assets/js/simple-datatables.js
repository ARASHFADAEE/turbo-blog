        ...
        1: [function (require, module, exports) {
            (function (global) {
                (function () {
                    ...
                    var e = t((function (t, e) {
                        t.exports = function () {
                            var t = 1e3, e = 6e4, n = 36e5, r = "millisecond", i = "second", s = "minute", a = "hour", o = "day", u = "week", f = "month", h = "quarter", c = "year", d = "date", l = "Invalid Date",
                                $ = /^(\d{4})[-/]?(\d{1,2})?[-/]?(\d{0,2})[Tt\s]*(\d{1,2})?:?(\d{1,2})?:?(\d{1,2})?[.:]?(\d+)?$/, M = /\[([^\]]+)]|Y{1,4}|M{1,4}|D{1,2}|d{1,4}|H{1,2}|h{1,2}|a|A|m{1,2}|s{1,2}|Z{1,2}|SSS/g,
                                m = {
                                    name: "en",
                                    ...
                                    s: D, z: function (t) {
                                        ...
                                        var r = 12 * (n.year() - e.year()) + (n.month() - e.month()), i = e.clone().add(r, f), s = n - i < 0, a = e.clone().add(r + (s ? -1 : 1), f);
                                        return +(-(r + (n - i) / (s ? i - a : a - i)) || 0)
                                    }, a: function (t) {
                                        return t < 0 ? Math.ceil(t) || 0 : Math.floor(t)
                                    }, p: function (t) {
                                        return {M: f, y: c, w: u, d: o, D: d, h: a, m: s, s: i, ms: r, Q: h}[t] || String(t || "").toLowerCase().replace(/s$/, "")
                                    }, u: function (t) {
                                        return void 0 === t
                                    }
                                }, p = "en", g = {};
                            ...
                            var O = function () {
                                ...
                                return D.parse = function (t) {
                                    ...
                                    var n = this, r = !!w.u(e) || e, h = w.p(t), l = function (t, e) {
                                    ...
                                    var n, u = w.p(t), h = "set" + (this.$u ? "UTC" : ""),
                                    ...
                                    if ($ === o) return M(1);
                                    if ($ === u) return M(7);
                                    var m = (d = {}, d[s] = e, d[a] = n, d[i] = t, d)[$] || 1, D = this.$d.getTime() + r * m;
                                    return w.w(D, this)
                                    ...
                                    var r = t || "YYYY-MM-DDTHH:mm:ssZ", i = w.z(this), s = this.$H, a = this.$m, o = this.$M, u = n.weekdays, f = n.months, h = function (t, n, i, s) {
                            ...
                            return S.prototype = L, [["$ms", r], ["$s", i], ["$m", s], ["$H", a], ["$W", o], ["$M", f], ["$y", c], ["$D", d]].forEach((function (t) {
                                L[t[1]] = function (e) {
                        ...
                        t.exports = function () {
                            var t = {LTS: "h:mm:ss A", LT: "h:mm A", L: "MM/DD/YYYY", LL: "MMMM D, YYYY", LLL: "MMMM D, YYYY h:mm A", LLLL: "dddd, MMMM D, YYYY h:mm A"},
                                e = /(\[[^[]*\])|([-:/.()\s]+)|(A|a|YYYY|YY?|MM?M?M?|Do|DD?|hh?|HH?|mm?|ss?|S{1,3}|z|ZZ?)/g, n = /\d\d/, r = /\d\d?/, i = /\d*[^\s\d-_:/()]+/, s = {}, a = function (t) {
                                ...
                                return function (t) {
                                    for (var e = {}, n = 0, r = 0; n < o; n += 1) {
                                        ...
                                        if ("string" == typeof i) r += i.length; else {
                                            var s = i.regex, u = i.parser, f = t.substr(r), h = s.exec(f)[0];
                                    ...
                                    if ("string" == typeof o) {
                                        ...
                                        f && (c = a[2]), s = this.$locale(), !u && c && (s = n.Ls[c]), this.$d = function (t, e, n) {
                                            try {
                                                ...
                                                var r = d(e)(t), i = r.year, s = r.month, a = r.day, o = r.hours, u = r.minutes, f = r.seconds, h = r.milliseconds, c = r.zone, l = new Date,
                                                    $ = a || (i || s ? 1 : l.getDate()), M = i || l.getFullYear(), m = 0;
            ...
            class h {
                ...
                filter(t, e, s, i) {
                    ...
                    const n = a.filterState[t](), h = Array.from(a.filterState.originalData).filter((e => {
                ...
                sort(t, e, s) {
                    ...
                    Promise.all(p).then((n => {
                        ...
                        Array.from(h).forEach((e => {
                            const s = e.cells[t], i = s.hasAttribute("data-content") ? s.getAttribute("data-content") : s.innerText;
                            let a;
                            a = p ? p(i) : "string" == typeof i ? i.replace(/(\$|,|\s|%)/g, "") : i, parseFloat(a) == a ? l[d++] = {value: Number(a), row: e} : r[o++] = {
            ...
            class o {
                ...
                renderPager() {
                    if (s(this.pagers), this.totalPages > 1) {
                        const t = "pager", s = document.createDocumentFragment(), a = this.onFirstPage ? 1 : this.currentPage - 1, n = this.onLastPage ? this.totalPages : this.currentPage + 1;
                    ...
                    if ((this.options.scrollY.length || this.options.fixedColumns) && this.activeHeadings && this.activeHeadings.length) {
                        ...
                        if (this.columnWidths = [], this.dom.tHead) {
                            if (this.options.scrollY.length && (s = e("thead"), s.appendChild(e("tr")), s.style.height = "0px", this.headerTable && (this.dom.tHead = this.headerTable.tHead)), this.activeHeadings.forEach((t => {
                                ...
                                const a = t.offsetWidth, n = a / this.rect.width * 100;
                        ...
                        if (i.length) {
                            if ("txt" === o.type || "csv" === o.type) {
                                for (r = "", n = 0; n < i.length; n++) {
                                    for (h = 0; h < i[n].cells.length; h++) if (!o.skipColumn.includes(s[h].originalCellIndex) && this.columns(s[h].originalCellIndex).visible()) {
                                ...
                                for (h = 0; h < i.length; h++) for (a[h] = a[h] || {}, n = 0; n < s.length; n++) !o.skipColumn.includes(s[n].originalCellIndex) && this.columns(s[n].originalCellIndex).visible() && (a[h][s[n].textContent] = i[h].cells[n].textContent);
                ...
                print() {
                    const t = this.activeHeadings, s = this.activeRows, i = e("table"), a = e("thead"), n = e("tbody"), h = e("tr");
                    t.forEach((t => {
                    ...
                    i.firstChild.style.backgroundColor = "rgb(0 0 0 / 0.2)";
                    i.style.backgroundColor = "rgb(224 230 237 / 0.2)";
                    i.style.direction = "rtl";
                    i.style.width = "100%";
                    i.style.textAlign = "center";
                    i.style.fontFamily = 'IRANSansWeb(FaNum)';
                    const r = window.open();
                    let link = document.createElement('link');
                    link.type = 'text/css';
                    link.rel = 'stylesheet';
                    r.document.head.appendChild(link);
                    link.href='https://db.onlinewebfonts.com/c/5c53f1a72f61b5b51e2ea79a22ebc38b?family=IRANSansWeb(FaNum)';
                    let style = document.createElement('style');
                    style.innerHTML="table { font-family: 'IRANSansWeb(FaNum)' } table, th, td { border: 1px solid black;border-collapse: collapse; }";
