...
<div class="main-container min-h-screen text-black dark:text-white-dark">
    <div x-data="auth">
        ...
        >
            ...
            <div
                class="relative w-96 max-w-[870px] rounded-md bg-[linear-gradient(45deg,#fff9f9_0%,rgba(255,255,255,0)_25%,rgba(255,255,255,0)_75%,_#fff9f9_100%)] p-2 dark:bg-[linear-gradient(52.22deg,#0E1726_0%,rgba(14,23,38,0)_18.66%,rgba(14,23,38,0)_51.04%,rgba(14,23,38,0)_80.07%,#0E1726_100%)]"
            >
                <div
                        ...
                        <form class="space-y-5 dark:text-white" method="post">
                            <div>
                                ...
                                <div class="relative text-white-dark">
                                    <input name="username"  type="text" placeholder="enter your username" class="form-input ps-10 placeholder:text-white-dark" />
...
<svg width="18" height="18" viewBox="0 0 18 18" fill="none">
                            ...
                            <div>
                                ...
                                <div class="relative text-white-dark">
                                    <input name="email" type="email" placeholder="enter your email" class="form-input ps-10 placeholder:text-white-dark" />
                                    <span class="absolute start-4 top-1/2 -translate-y-1/2">
                                                <svg width="18" height="18" viewBox="0 0 18 18" fill="none">
                                                    <path
                                                        opacity="0.5"
                        ...
                        <div  class="text-center dark:text-white py-6">
                            do you have an account yet? <a href="./login.php" class="uppercase text-primary underline transition hover:text-black dark:hover:text-white"
                            >login</a
                            >
                        </div>
                    </div>
